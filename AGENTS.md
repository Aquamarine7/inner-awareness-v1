...
Inner Awareness is a personal content platform for the owner to publish pain-point insights, educational posts, and self-awareness resources targeted at career women aged 25–35.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "154355798+Aquamarine7@users.noreply.github.com"
  git config user.name "Aquamarine7"
  ```
